...
<div class="flex items-center justify-between mb-6 animate-fade-in-up">
    ...
    <div class="flex items-center gap-3">
        <a href="{{ route('products.printLabels') }}" target="_blank"
           class="inline-flex items-center gap-2 rounded-xl bg-white border border-gray-200 px-5 py-2.5 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-50 hover:scale-[1.02] hover:-translate-y-0.5 transition-all duration-300">
        ...
        <table class="min-w-full divide-y divide-gray-100">
            <thead class="bg-gray-50/50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Barcode</th>
